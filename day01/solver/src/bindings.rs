    ...
    pub mod aoc2024 {
        ...
        pub mod day01 {
            ...
            pub mod solver {
                ...
                #[doc(hidden)]
                macro_rules! __export_aoc2024_day01_solver_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name = "aoc2024:day01/solver#solve-a"]
                        unsafe extern "C" fn export_solve_a(arg0 : * mut u8, arg1 :
                        usize,) -> i32 { $($path_to_types)*:: _export_solve_a_cabi::<$ty
                        > (arg0, arg1) } #[export_name = "aoc2024:day01/solver#solve-b"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_aoc2024_day01_solver_cabi;
            }
        }
    }
}
...
macro_rules! __export_solver_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::aoc2024::day01::solver::__export_aoc2024_day01_solver_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::aoc2024::day01::solver);
    };
}
#[doc(inline)]
pub(crate) use __export_solver_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day01-solver:solver:encoded world"]
#[doc(hidden)]
...
B\x05\x01o\x02zz\x01p\0\x01@\x01\x05input\x01\0z\x04\0\x07solve-a\x01\x02\x04\0\x07\
solve-b\x01\x02\x04\0\x14aoc2024:day01/solver\x05\0\x04\0\x1baoc2024:day01-solve\
