...
pub mod aoc2024 {
    ...
    pub mod day17 {
        ...
        pub mod solver {
            ...
            pub fn solve_a(input: &Machine) -> _rt::Vec<u8> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
                    let Machine {
                        register_a: register_a0,
                        register_b: register_b0,
                        register_c: register_c0,
                        program: program0,
                    } = input;
                    let vec1 = program0;
                    ...
                    #[link(wasm_import_module = "aoc2024:day17/solver")]
                    extern "C" {
                        #[link_name = "solve-a"]
                        fn wit_import(
                            _: i64,
                    ...
                    wit_import(
                        _rt::as_i64(register_a0),
                        _rt::as_i64(register_b0),
                        _rt::as_i64(register_c0),
                        ptr1.cast_mut(),
                        len1,
                        ptr2,
                    );
            ...
            pub fn solve_b(input: &Machine) -> u64 {
                unsafe {
                    ...
                    #[cfg(not(target_arch = "wasm32"))]
                    fn wit_import(_: i64, _: i64, _: i64, _: *mut u8, _: usize) -> i64 {
                        unreachable!()
                    }
                    let ret = wit_import(
                        _rt::as_i64(register_a0),
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day17-parser:parser:encoded world"]
#[doc(hidden)]
...
A\x04\x01B\x07\x01p}\x01r\x04\x0aregister-aw\x0aregister-bw\x0aregister-cw\x07pr\
ogram\0\x04\0\x07machine\x03\0\x01\x01@\x01\x05input\x02\0\0\x04\0\x07solve-a\x01\
\x03\x01@\x01\x05input\x02\0w\x04\0\x07solve-b\x01\x04\x03\0\x14aoc2024:day17/so\
lver\x05\0\x01B\x08\x04\0\x06runner\x03\x01\x01i\0\x01@\x01\x05inputs\0\x01\x04\0\
\x13[constructor]runner\x01\x02\x01h\0\x01@\x01\x04self\x03\0s\x04\0\x16[method]\
runner.solve-a\x01\x04\x04\0\x16[method]runner.solve-b\x01\x04\x04\0\x0caoc:base\
/day\x05\x01\x04\0\x1baoc2024:day17-parser/parser\x04\0\x0b\x0c\x01\0\x06parser\x03\
