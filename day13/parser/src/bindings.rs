...
pub mod aoc2024 {
    ...
    pub mod day13 {
        ...
        pub mod solver {
            ...
            pub fn solve_a(input: &[Machine]) -> u64 {
                unsafe {
                    let vec0 = input;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "aoc2024:day13/solver")]
                    extern "C" {
                        #[link_name = "solve-a"]
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn solve_b(input: &[Machine]) -> u64 {
                unsafe {
                    let vec0 = input;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day13-parser:parser:encoded world"]
#[doc(hidden)]
...
A\x04\x01B\x0a\x01r\x02\x01xx\x01yx\x04\0\x0cbutton-press\x03\0\0\x01r\x02\x01xx\
\x01yx\x04\0\x08position\x03\0\x02\x01r\x03\x08button-a\x01\x08button-b\x01\x05p\
rize\x03\x04\0\x07machine\x03\0\x04\x01p\x05\x01@\x01\x05input\x06\0w\x04\0\x07s\
olve-a\x01\x07\x04\0\x07solve-b\x01\x07\x03\0\x14aoc2024:day13/solver\x05\0\x01B\
\x08\x04\0\x06runner\x03\x01\x01i\0\x01@\x01\x05inputs\0\x01\x04\0\x13[construct\
or]runner\x01\x02\x01h\0\x01@\x01\x04self\x03\0s\x04\0\x16[method]runner.solve-a\
\x01\x04\x04\0\x16[method]runner.solve-b\x01\x04\x04\0\x0caoc:base/day\x05\x01\x04\
\0\x1baoc2024:day13-parser/parser\x04\0\x0b\x0c\x01\0\x06parser\x03\0\0\0G\x09pr\
