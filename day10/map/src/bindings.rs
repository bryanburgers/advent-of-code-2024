...
#[doc(inline)]
pub(crate) use __export_map_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day10-map:map:encoded world"]
#[doc(hidden)]
...
A\x02\x01B\x0c\x04\0\x11topographical-map\x03\x01\x01p}\x01p\x01\x01i\0\x01@\x01\
...
method]topographical-map.height-at-location\x01\x07\x04\0\x13aoc2024:day10/types\
\x05\0\x04\0\x15aoc2024:day10-map/map\x04\0\x0b\x09\x01\0\x03map\x03\0\0\0G\x09p\
