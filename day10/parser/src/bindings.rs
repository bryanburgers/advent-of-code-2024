...
macro_rules! __export_parser_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        $($path_to_types_root)*:: exports::aoc::base::day); $($path_to_types_root)*::
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd8\x05\x01A\x02\x01\
A\x09\x01B\x0c\x04\0\x11topographical-map\x03\x01\x01p}\x01p\x01\x01i\0\x01@\x01\
...
ss\x01@\x01\x05inputs\0\0\x04\0\x03run\x01\x01\x04\0\x0caoc:base/day\x05\x03\x01\
B\x0c\x04\0\x11topographical-map\x03\x01\x01p}\x01p\x01\x01i\0\x01@\x01\x03map\x02\
\0\x03\x04\0\x1e[constructor]topographical-map\x01\x04\x01h\0\x01@\x01\x04self\x05\
\0y\x04\0#[method]topographical-map.map-width\x01\x06\x04\0$[method]topographica\
l-map.map-height\x01\x06\x01@\x03\x04self\x05\x01xy\x01yy\0}\x04\0,[method]topog\
raphical-map.height-at-location\x01\x07\x04\0\x13aoc2024:day10/types\x05\x04\x04\
