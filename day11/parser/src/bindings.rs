...
pub mod aoc2024 {
    ...
    pub mod day11 {
        ...
        pub mod solver {
            ...
            pub fn solve_a(input: &[u64]) -> u64 {
                unsafe {
                    let vec0 = input;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "aoc2024:day11/solver")]
                    extern "C" {
                        #[link_name = "solve-a"]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day11-parser:parser:encoded world"]
#[doc(hidden)]
...
A\x04\x01B\x04\x01pw\x01@\x01\x05input\0\0w\x04\0\x07solve-a\x01\x01\x04\0\x07so\
lve-b\x01\x01\x03\0\x14aoc2024:day11/solver\x05\0\x01B\x08\x04\0\x06runner\x03\x01\
\x01i\0\x01@\x01\x05inputs\0\x01\x04\0\x13[constructor]runner\x01\x02\x01h\0\x01\
@\x01\x04self\x03\0s\x04\0\x16[method]runner.solve-a\x01\x04\x04\0\x16[method]ru\
nner.solve-b\x01\x04\x04\0\x0caoc:base/day\x05\x01\x04\0\x1baoc2024:day11-parser\
