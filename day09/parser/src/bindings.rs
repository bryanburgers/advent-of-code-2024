...
pub mod aoc2024 {
    ...
    pub mod day09 {
        ...
        pub mod solver {
            ...
            pub fn solve_a(input: &[u8]) -> u64 {
                unsafe {
                    let vec0 = input;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "aoc2024:day09/solver")]
                    extern "C" {
                        #[link_name = "solve-a"]
...
lve-b\x01\x01\x03\0\x14aoc2024:day09/solver\x05\0\x01B\x08\x04\0\x06runner\x03\x01\
...
nner.solve-b\x01\x04\x04\0\x0caoc:base/day\x05\x01\x04\0\x1baoc2024:day09-parser\
