    ...
    pub mod day14 {
        ...
        pub mod solver {
            ...
            pub fn solve_a(input: &Input) -> u64 {
                unsafe {
                    let Input { robots: robots0, size: size0 } = input;
                    let vec1 = robots0;
                    let ptr1 = vec1.as_ptr().cast::<u8>();
                    let len1 = vec1.len();
                    let Size { width: width2, height: height2 } = size0;
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "aoc2024:day14/solver")]
                    extern "C" {
                        #[link_name = "solve-a"]
                        fn wit_import(_: *mut u8, _: usize, _: i64, _: i64) -> i64;
                    }
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day14-parser:parser:encoded world"]
#[doc(hidden)]
...
A\x04\x01B\x0e\x01r\x02\x01xx\x01yx\x04\0\x08position\x03\0\0\x01r\x02\x01xx\x01\
yx\x04\0\x08velocity\x03\0\x02\x01r\x02\x08position\x01\x08velocity\x03\x04\0\x05\
robot\x03\0\x04\x01r\x02\x05widthx\x06heightx\x04\0\x04size\x03\0\x06\x01p\x05\x01\
r\x02\x06robots\x08\x04size\x07\x04\0\x05input\x03\0\x09\x01@\x01\x05input\x0a\0\
w\x04\0\x07solve-a\x01\x0b\x04\0\x07solve-b\x01\x0b\x03\0\x14aoc2024:day14/solve\
r\x05\0\x01B\x08\x04\0\x06runner\x03\x01\x01i\0\x01@\x01\x05inputs\0\x01\x04\0\x13\
[constructor]runner\x01\x02\x01h\0\x01@\x01\x04self\x03\0s\x04\0\x16[method]runn\
er.solve-a\x01\x04\x04\0\x16[method]runner.solve-b\x01\x04\x04\0\x0caoc:base/day\
\x05\x01\x04\0\x1baoc2024:day14-parser/parser\x04\0\x0b\x0c\x01\0\x06parser\x03\0\
