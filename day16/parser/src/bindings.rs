...
pub mod aoc2024 {
    ...
    pub mod day16 {
        ...
        pub mod solver {
            ...
            pub fn solve_a(input: &[_rt::Vec<Tile>]) -> u64 {
                unsafe {
                    ...
                    #[link(wasm_import_module = "aoc2024:day16/solver")]
                    extern "C" {
                        #[link_name = "solve-a"]
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn solve_b(input: &[_rt::Vec<Tile>]) -> u64 {
                unsafe {
                    let mut cleanup_list = _rt::Vec::new();
                    let vec1 = input;
                    let len1 = vec1.len();
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:aoc2024:day16-parser:parser:encoded world"]
#[doc(hidden)]
...
A\x04\x01B\x07\x01m\x04\x04open\x04wall\x05start\x03end\x04\0\x04tile\x03\0\0\x01\
p\x01\x01p\x02\x01@\x01\x05input\x03\0w\x04\0\x07solve-a\x01\x04\x04\0\x07solve-\
b\x01\x04\x03\0\x14aoc2024:day16/solver\x05\0\x01B\x08\x04\0\x06runner\x03\x01\x01\
...
solve-b\x01\x04\x04\0\x0caoc:base/day\x05\x01\x04\0\x1baoc2024:day16-parser/pars\
